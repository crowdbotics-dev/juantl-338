"""
Django settings for juantl_338 project.
...
WSGI_APPLICATION = 'juantl_338.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "juantl_338 API",
    "DESCRIPTION": "API documentation for juantl_338 App",
    "VERSION": "v1",
}
